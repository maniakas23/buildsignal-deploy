  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-2 px-3 py-2 bg-amber-50 border border-amber-200 rounded-lg">
        <span className="text-sm text-amber-700 font-medium">Sample Data — All figures below are illustrative placeholders for UI demonstration. Not live validation results.</span>
      </div>
      {/* Overall Status */}
