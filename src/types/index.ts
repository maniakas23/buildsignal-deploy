...
export interface Pattern { id: string; name: string; description: string; confidence: number; maturity: number; status: string; evidenceCount?: number; isActive?: boolean; }
...
export interface Summary { content: string; generatedAt: string; period?: string; highlights?: string[]; }
export interface GrowthStory { id: string; title: string; description: string; county?: string; state?: string; confidence?: number; evidenceSummary?: string; detectedAt?: string; }
